...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/matia/Desktop/universidad/dsed/github/DSED_VHDL_NEXUSDDR-master/Proyecto_dsed_final/Proyecto_dsed_final.cache/compile_simlib/riviera"
  fi
